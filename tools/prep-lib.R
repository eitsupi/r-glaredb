# Copied from https://github.com/pola-rs/r-polars/blob/3d2a33361e6765294e3e44201b92429c28b67402/tools/prep-lib.R
...
target_url <- sprintf(
  "https://github.com/eitsupi/r-glaredb/releases/download/%s%s/libr_glaredb-%s-%s.tar.gz",
  lib_tag_prefix,
  lib_version,
  lib_version,
  target_triple
